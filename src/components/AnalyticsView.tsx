    ...
    <div className="space-y-4 pb-28">
      ...
      <div>
        <h2 className="text-lg font-serif font-bold text-[#f7f3ee] flex items-center gap-2">
          <Compass className="w-5 h-5 text-[#e6a15c]" /> Somatic Progression Analytics
        </h2>
        <p className="text-xs text-[#a39588] font-light">
          Observe physical volume growth, muscle vessel engagement & somatic harmony
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="bg-[#181412]/90 border border-[#382f29] p-3 rounded-2xl text-center space-y-1">
          <span className="text-[10px] text-[#8c7e72] font-syne uppercase font-semibold block">Somatic Load</span>
        ...
        <div className="bg-[#181412]/90 border border-[#382f29] p-3 rounded-2xl text-center space-y-1">
          <span className="text-[10px] text-[#8c7e72] font-syne uppercase font-semibold block">Sessions</span>
          <span className="text-base font-bold font-mono text-[#849a88]">
            {totalWorkouts} <span className="text-xs text-[#a39588] font-normal">flows</span>
          </span>
        </div>

        <div className="bg-[#181412]/90 border border-[#382f29] p-3 rounded-2xl text-center space-y-1">
          <span className="text-[10px] text-[#8c7e72] font-syne uppercase font-semibold block">Total Sets</span>
          <span className="text-base font-bold font-mono text-[#f5c999]">
            {totalSetsAllTime} <span className="text-xs text-[#a39588] font-normal">sets</span>
          </span>
        </div>
      </div>
      ...
      <div className="bg-[#181412]/90 border border-[#382f29] rounded-3xl p-4 space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="text-xs uppercase font-syne font-bold text-[#c8b8a8] tracking-wider flex items-center gap-1.5">
            <TrendingUp className="w-4 h-4 text-[#849a88]" /> Somatic Volume Progression
          </h3>
          <span className="text-[10px] text-[#8c7e72]">Last 5 Sessions</span>
        </div>

        {recentWorkouts.length === 0 ? (
          <p className="text-xs text-[#6b5e54] font-serif italic py-4 text-center">Complete somatic sessions to view volume momentum</p>
        ) : (
      ...
      <div className="bg-[#181412]/90 border border-[#382f29] rounded-3xl p-4 space-y-3">
        <h3 className="text-xs uppercase font-syne font-bold text-[#c8b8a8] tracking-wider flex items-center gap-1.5">
          <Activity className="w-4 h-4 text-[#e6a15c]" /> Vessel Muscle Engagement
        </h3>
      ...
      <div className="bg-gradient-to-br from-[#231b16] via-[#181412] to-[#100d0b] border border-[#d97724]/30 rounded-3xl p-4 space-y-2">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-xs font-syne font-bold text-[#f5c999] uppercase tracking-wider">
            Guide Integration Ready
          </h4>
        </div>
        <p className="text-xs text-[#c8b8a8] font-light leading-relaxed">
          All session logs include somatic feedback tags, seat notch alignments, and reflection notes ready to instantly render into warm PNG reports for your Guide.
        </p>
      </div>
    </div>
  );
